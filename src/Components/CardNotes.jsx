...
const CardNotes = ({ note, onDelete, id }) => {
          ...
          <section className="note-body">
            <div className="note-label">
              ...
              <TooltipBlack slots={{transition: Zoom}} title="See The Details" placement="top"  arrow>
                ...
                <Link to={`/updatenote/${id}`} className="Edit">                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
